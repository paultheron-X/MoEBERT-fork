...
if [ $1 = "qnli" ]
then
    bash sh_scripts/experiments/base_finetuning.sh qnli 1 3e-5 16 0 9
...
then
    bash sh_scripts/experiments/base_finetuning.sh qqp 1 2e-5 8 0.01 2
...
then
    bash sh_scripts/experiments/base_finetuning.sh sst2 1 3e-5 32 0.01 3
    export eval_steps=1000
...
then
    bash sh_scripts/experiments/base_finetuning.sh mnli 1 3e-5 16 0.01 2
    export eval_steps=2000
...
then
    bash sh_scripts/experiments/base_finetuning.sh cola 1 3e-5 32 0.01 7
...
then
    bash sh_scripts/experiments/base_finetuning.sh mrpc 1 4e-5 8 0 2
