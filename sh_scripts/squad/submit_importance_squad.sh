...
#SBATCH --output=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_importance_squad_out%j.txt
#SBATCH --error=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_importance_squad_err%j.txt
...
bash sh_scripts/experiments/importance_preprocess_squad.sh squad_v2 $output_dir