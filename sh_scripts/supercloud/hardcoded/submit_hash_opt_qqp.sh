...
#SBATCH --output=/home/gridsan/ptheron/MoEBERT-fork/logs/hash_qqp_out%j.txt
#SBATCH --error=/home/gridsan/ptheron/MoEBERT-fork/logs/hash_qqp_err%j.txt
...
bash sh_scripts/experiments/hc/moebert_hash_qqp.sh