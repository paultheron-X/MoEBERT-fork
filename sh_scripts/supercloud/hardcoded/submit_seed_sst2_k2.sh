...
#SBATCH -N 1
#SBATCH --job-name moebert_k2_finetuning_sst2
...
#SBATCH --output=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_k2_seeds_sst2_out%j.txt
#SBATCH --error=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_k2_seeds_sst2_err%j.txt

echo "Launching seeds finetuning for dataset sst2"
...
bash sh_scripts/experiments/launch_more_seeds_k2.sh sst2 $output_dir