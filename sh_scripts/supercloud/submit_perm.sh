...
#SBATCH -N 1
#SBATCH --job-name moebert_perm_finetuning_$1
...
#SBATCH --output=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_perm_$1_out%j.txt
#SBATCH --error=/home/gridsan/ptheron/MoEBERT-fork/logs/experiments_perm_$1_err%j.txt
...
bash sh_scripts/experiments/launch_jobs_perm.sh $1 $output_dir