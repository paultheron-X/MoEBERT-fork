...
class LearnPermutationsBase(nn.Module):
    """Learn permutations.
    Input:
    ...
    def __init__(
        ...
        super(LearnPermutationsBase, self).__init__()
    ...
    def _get_permutation_during_training(
        ...
        n_iters = torch.tensor(
            20 + (150 - 20) * self.iterations / self.iterations_for_learning_permutation
        )  # Now it's a tensor and checked
